...
$(document).ready(function(){
	...
	$(this).attr("title", "Client 선택 popup | M-Library");
...
<form id="searchForm">
<div class="tac mt25">
	<strong class="black mr10">Client명</strong>
	...
	<div class="tableScoll">
		...
		<table class="tableComm table1 tablePop1">
			...
			<tbody>
				...
				<tr>
					<td>
						<input type="hidden" value="<c:out value='${client.CD}'/>"/>
						<a href="javascript:select('${client.CD}','${client.NM}');">
							<c:out value="${client.NM}"/>
						</a>
					</td>
				</tr>
				</c:forEach>
