...
$(document).ready(function(){
	...
	$(this).attr("title", "수정 | Potential Client | M-Library");
	...
	$('#contactPathCd').val('<c:out value="${vc.CONTACT_PATH_CD}"/>');
	$('#contactPathCd').msDropDown().data("dd").set("value", '<c:out value="${vc.CONTACT_PATH_CD}"/>');
	
	$('#bizCd').val('<c:out value="${vc.BIZ_CD}"/>');
	$('#bizCd').msDropDown().data("dd").set("value", '<c:out value="${vc.BIZ_CD}"/>');
...
<table class="tableComm mb30">
	...
	<tbody>
		<tr>
			...
			<td colspan="3">
				<input type="text" id="title" name="title" value="<c:out value='${vc.TITLE}'/>" maxlength="100" style="width:581px;" placeholder="Client명을 포함하여 작성">
			</td>
		</tr>
		<tr>
			<th>예상빌링 <span class="red">*</span> </th>
			<td>
				<input type="text" id="billing" name="billing" value="<c:out value='${vc.BILLING}'/>" maxlength="100" title="도/예상빌링" style="width:233px;">
			</td>
		...
		<tr>
			...
			<td>
				<input type="text" id="contactDt" name="contactDt" value="<fmt:formatDate value='${vc.CONTACT_DT}' pattern='yyyy-MM-dd'/>" readOnly/>
			</td>
		...
		<tr>
			...
			<td colspan="3">
				<input type="text" id="coAttend" name="coAttend" value="<c:out value="${vc.CO_ATTEND}"/>" maxlength="100" style="width:581px;" placeholder="[팀명] 이름, [팀명] 이름"/>
			</td>
		</tr>
		<tr>
			<th>광고주 참석자 <span class="red">*</span> </th>
			<td colspan="3">
				<input type="text" id="adAttend" name="adAttend" value="<c:out value="${vc.AD_ATTEND}"/>" maxlength="100" style="width:581px;" placeholder="[팀명] 이름+직책, [팀명] 이름+직책"/>
			</td>
		</tr>
...
<table class="tableComm mtable1 mb30">
	...
	<tbody>
		<tr>
			...
			<td>
				<textArea style="width:100%; height:300px" id="ir1" style="width:96%; height:70px;"><c:out value="${vc.CONT}" escapeXml="false"/></textArea>
		...
		<tr>
			<th>본부장<br>의견</th>
			<td>
			<textarea title="본부장 의견" style="width:96%; height:70px;" placeholder="본부장 의견 자유롭게 작성" disabled><c:out value="${vc.DIRECTOR_COMMENT}"/></textarea></td>
		</tr>
	</tbody>
</table>
