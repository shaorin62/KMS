...
$(document).ready(function(){
	$(this).attr('title','수정 | Credential | M-Library');
	...
	<table class="tableComm mb40">
		...
		<tbody>
			...
			<tr>
				...
				<th>작성일</th>
				<td>
					<fmt:formatDate value="${resultMap.UPD_DTM}" pattern="yyyy.MM.dd"/>	
				</td>
			</tr>
		</tbody>
	</table>
...
<form id="uploadForm">
	...
	<input type="hidden" id="bid" name="bid" value="${resultMap.bid }"/>
</form>
